    ...
    <div className="flex items-center justify-center p-6">
      <div className="max-w-3xl w-full">
        ...
        <div className="flex flex-col items-center">
          ...
          {/* Icon */}
          <div className="bg-blue-500 rounded-2xl p-6 shadow-lg mb-8 relative">
          ...
          {/* Subheading */}
          <p className="text-Secondary font-semibold text-center text-lg mb-12 max-w-2xl">
            Thanks for sharing your details — our team has everything we need to find health cover that fits you best
          </p>

          {/* Description */}
          <p className="font-semibold text-center text-base mb-16 max-w-2xl">
          ...
          {/* Call button */}
          <button className="bg-blue-500 hover:bg-blue-600 text-white font-semibold px-8 py-4 rounded-full flex items-center gap-3 transition-colors shadow-lg mb-8">
