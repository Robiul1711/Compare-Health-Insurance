...
const ContactUs = () => {
  return (
    <div className='bg-[#1F1F1F]/70 py-14 flex items-center justify-center flex-col gap-4 text-center'>
  ...
  <button className='py-2 px-10 bg-white rounded-full font-medium text-lg'>Contact Us</button>
    </div>
  )
}
